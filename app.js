...
const NEWS = [
  ...
  {id:73,t:'pfe',src:'Presidential Docs',url:'https://www.federalregister.gov/documents/2026/08/31/2026-18302/2026-18302',time:'10:45',d:Date.now(),title:{zh:'宣布国家紧急状态以确保美国电力系统安全',en:'Declaring a national emergency to ensure the security of the US electricity supply'},sum:{zh:'总统发布公告，依据《联邦电力法》第 202(c) 条与《国防生产法》宣布国家紧急状态，指示能源部长确保关键发电机组（含燃煤与核电）维持运行或恢复出力、禁止未经联邦许可的机组退役，并设立电力优先调度与互联互通快速通道，优先保障 AI 数据中心与制造业新增负荷的供电可靠性。',en:"The President issued a proclamation declaring a national emergency under Section 202(c) of the Federal Power Act and the Defense Production Act, directing the Secretary of Energy to keep critical generating units (including coal and nuclear) online or restore output, bar unauthorized retirements, and establish priority dispatch and fast-track interconnection to secure reliable power for AI data centers and manufacturing load."},tags:['National Emergency','Grid Security'],cn:'USA'},
  /* ---- USA / PFE ---- */
